...
/**
 * A class modeling the hotel reservation system itself, mostly how it handles
 * customers.
 */
public class HotelSystem {
    ...
    /**
     * Adds a customer to the hashmap, first checking if that customer already exists.
